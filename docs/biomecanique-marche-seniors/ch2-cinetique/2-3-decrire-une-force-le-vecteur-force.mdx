...
<ChapterHeader
  title="2.3 Décrire une force : le vecteur force"
  meta={<><Badge tone="violet">Biomécanique</Badge><Badge tone="teal">Cinétique</Badge><Badge tone="neutral">Section 2.3</Badge><span style={{font:"var(--type-code)",fontSize:12,color:"var(--text-muted)"}}>6 min de lecture</span><span style={{font:"var(--type-code)",fontSize:12,color:"var(--text-muted)"}}>mis à jour le 28 août 2026</span></>}
>
...
<Figure number="2.3" alt="La flèche du vecteur force et ses trois lectures : origine (point d'application), orientation (direction et sens), longueur (intensité)." caption="La flèche du vecteur force et ses trois lectures : origine (point d'application), orientation (direction et sens), longueur (intensité)." source="diaporama CM2, dia 13 — figure à ré-exporter." />
...
<Figure number="2.4" alt="Un vecteur force dans un repère gradué en newtons : ses composantes et son intensité (235 N)." caption="Un vecteur force dans un repère gradué en newtons : ses composantes et son intensité (235 N)." source="diaporama CM2, dia 14 — figure à ré-exporter." />
