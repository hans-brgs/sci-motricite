...
<ChapterHeader
  title="2.2 Qu'est-ce qu'une force ?"
  meta={<><Badge tone="violet">Biomécanique</Badge><Badge tone="teal">Cinétique</Badge><Badge tone="neutral">Section 2.2</Badge><span style={{font:"var(--type-code)",fontSize:12,color:"var(--text-muted)"}}>7 min de lecture</span><span style={{font:"var(--type-code)",fontSize:12,color:"var(--text-muted)"}}>mis à jour le 28 août 2026</span></>}
>
...
<Figure number="2.2" alt="Les cinq modes de charge : compression, tension, cisaillement, torsion, flexion. (Schéma à produire — hors diaporama.)" caption="Les cinq modes de charge : compression, tension, cisaillement, torsion, flexion. (Schéma à produire — hors diaporama.)" />
