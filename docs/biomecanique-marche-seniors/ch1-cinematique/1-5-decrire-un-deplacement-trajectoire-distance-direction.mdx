...
<Figure number="1.4" src="/img/figures/ch1-cinematique/fig-1-04-etapes-du-calcul-de-distance.png" alt="Les quatre étapes du calcul, en images. (Suite d'images à produire à partir des dias 29-35, ou animation — lien YouTube à venir.)" caption="Les quatre étapes du calcul, en images. (Suite d'images à produire à partir des dias 29-35, ou animation — lien YouTube à venir.)" />
...
<Figure number="1.5" src="/img/figures/ch1-cinematique/fig-1-05-distance-cumulee.png" alt="Un tracé découpé en quatre segments : chaque segment est mesuré avec la formule ci-dessus, et la distance cumulée est la somme des segments. (Figure à produire à partir du tracé GPS du diaporama, dias 24 et 37.)" caption="Un tracé découpé en quatre segments : chaque segment est mesuré avec la formule ci-dessus, et la distance cumulée est la somme des segments. (Figure à produire à partir du tracé GPS du diaporama, dias 24 et 37.)" />
...
<Figure number="1.6" src="/img/figures/ch1-cinematique/fig-1-06-cercle-des-points-equidistants.png" alt="Le cercle des points situés à 235 m de A : sans direction, B peut se trouver n'importe où sur ce cercle. (Illustration à produire, d'après les dias 41-44.)" caption="Le cercle des points situés à 235 m de A : sans direction, B peut se trouver n'importe où sur ce cercle. (Illustration à produire, d'après les dias 41-44.)" />

<Figure number="1.7" src="/img/figures/ch1-cinematique/fig-1-07-vecteur-deplacement.png" alt="La flèche de A vers B et ses composantes Δx et Δy : le vecteur déplacement. (Illustration à produire, d'après les dias 45-46.)" caption="La flèche de A vers B et ses composantes Δx et Δy : le vecteur déplacement. (Illustration à produire, d'après les dias 45-46.)" />
