...
<ChapterHeader
  title="1.6 La vitesse"
  meta={<><Badge tone="violet">Biomécanique</Badge><Badge tone="teal">Cinématique</Badge><Badge tone="neutral">Section 1.6</Badge><span style={{font:"var(--type-code)",fontSize:12,color:"var(--text-muted)"}}>8 min de lecture</span><span style={{font:"var(--type-code)",fontSize:12,color:"var(--text-muted)"}}>mis à jour le 17 août 2026</span></>}
>
...
<Figure number="1.8" src="/img/figures/ch1-cinematique/fig-1-08-vitesse-instantanee-et-moyenne.png" alt="Vitesse du coureur en fonction du temps : en barres, les vitesses moyennes par intervalle de 0,25 s ; en trait plein, la vitesse instantanée ; en pointillés, la vitesse moyenne de la course (5,0 m/s)." caption="Vitesse du coureur en fonction du temps : en barres, les vitesses moyennes par intervalle de 0,25 s ; en trait plein, la vitesse instantanée ; en pointillés, la vitesse moyenne de la course (5,0 m/s)." source="diaporama CM1, dia 54 — figure à ré-exporter." />
